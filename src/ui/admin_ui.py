...
from ..utils.general_utils import make_printable,take_address_input,int_input
...
class Admin_interface(EmployeeInterface):
    ...
    def create_employee_form(self):
        ...
        user_type_input = int_input("Enter press 1 to create worker and 0 to create HR employee")
        worker_dict ={}
        ...
        # while True:
        #     worker_dict["phone"] = input(f"Enter {worker_dict["user_type"]}'s phone number : ")
        ...
        reports_to = int_input(f"Enter the employee id of the person who {worker_dict["name"]} reports to : ")
