...
class Worker_interface(EmployeeInterface):
    ...
    def reported_by_ui(self, empId):
        ...
        op = int_input("To see more information about any of the employees press 1\n Or press 0 to continue : ")
        if op == 1:
            while True:
                input_empId = int_input("Enter the employee id of the person you want more information of : ")
                for reported_by in reported_by_workers:
